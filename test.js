...
class ProductManager {
    ...
    async addProduct(title, description, code, price, thumbnail, stock) {
        ...
        const newProd = { title: title, description: description, code: code, price: price, thumbnail: thumbnail, stock: stock, id: await this.setIdCode() }
        const content = await fs.promises.readFile('productManager.json', 'utf-8')
...
async function storageAsync() {
    ...
    // console.log(await productManager.getProductByCode("01HF2XA41T3AZJ18Q2GWSN6H6Y"))
